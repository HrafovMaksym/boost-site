      ...
      <div className="bg-[#0b0e16] border border-[#1f2330] rounded-[32px] p-1 shadow-2xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 relative z-10">
          ...
          <div className="lg:col-span-3 p-8 bg-[#0d111a] flex flex-col justify-between">
            ...
            <button className="w-full cursor-pointer bg-blue-600 hover:bg-blue-500 py-5 rounded-2xl font-black transition-all text-white flex items-center justify-center gap-3 active:scale-95 shadow-xl shadow-blue-900/20 group uppercase tracking-tight text-sm">
              Ready to Boost
              <ChevronRight
                size={18}
